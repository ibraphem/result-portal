...
$limit = 7;
    ...
    $queryNum = $db->query("SELECT COUNT(*) as postNum FROM student");
...
<body class="">
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="student.php"><h4>Students' List</h4></a>
          </div>
     ...
     <?php
     $result = mysqli_query($connect,"SELECT * FROM `student` ORDER BY id DESC LIMIT $limit");
    ...
    <div id="add_data_Modal" class="modal fade" role="dialog" style="height: 500px;">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form name="customer" id="insert_form" method="post">
                            <input type="text" placeholder="Enter student's fullname" name="name" id="name" required=""/>
                            <input type="text" placeholder="Enter student's admission number" name="admission_no" id="admission_no" required=""/>
                            <input type="password" placeholder="Set student password" name="password" id="password" required=""/>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header login-header">
                    <button type="button" class="close" data-dismiss="modal">X</button>
                    <h4 class="modal-title">Delete Student's Record</h4>
                </div>
                <div class="modal-body">
    ...
    <div id="todo_modal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header login-header">
                    <button type="button" class="close" data-dismiss="modal">X</button>
                    <h4 class="modal-title">Status Plane</h4>
                </div>
                <div class="modal-body">
                <form name="todoForm" id="todoForm">
                <input type="text" name="todo_id" id="todo_id" style="display: none;" />
                <input type="text" name="active" id="active" style="display: none;" />
                </form>
                <div class="deleteContent">
					<h5>Do you want to block this student?</h5>
    ...
    <div id="block_modal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                <form name="blockerForm" id="blockerForm">
                <input type="text" name="blocker_id" id="blocker_id" style="display: none;" />
                <input type="text" name="block" id="block" style="display: none;" />
                </form>
                <div class="deleteContent">
					<h5>Do you want to unblock this student?</h5>

				</div>
                </div>
                <div class="modal-footer">
                    <button type="submit" class="add-project" form="blockerForm" name="blocking" id="blocking" value="Yes">Yes</button>
                    <button type="button" class="cancel" data-dismiss="modal">No</button>
                </div>
            </div>
